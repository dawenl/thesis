...
log-probability
  \begin{align*}
    \log \mathbb{P}(y^\text{pred}_{ui} \leq 0 \g \mathcal{D}) =
    \log\big(\pi_{ui} \mathbb{P}(y^\text{pred}_{ui} \leq 0 \g a_{ui} =
