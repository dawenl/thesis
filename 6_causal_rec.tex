...
\parhead{Popularity model.} For popularity exposure model $a_{ui} \sim \mathrm{Bernoulli}(\rho_i)$, we obtain the maximum likelihood estimate $\tilde{\rho}_i$ by counting the portion of the users who have been exposed to item $i$. The propensity score in this case is fixed across users: 
\begin{equation}
