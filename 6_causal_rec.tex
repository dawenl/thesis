...
factorization~\citep{mnih2007probabilistic} in \Cref{chpt:background:sec:mf_cf}. Conditional on being
...
estimates of the parameters $\mb\theta_u$ and $\mb\beta_i$. Concretely, the objective for the inverse propensity weighted Gaussian matrix factorization model (\Cref{eq:causal-training}) is:
\begin{equation*}
